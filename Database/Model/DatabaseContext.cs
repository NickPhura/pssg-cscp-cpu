...
// Created via this command line: PAC modelbuilder build --outdirectory C:\git\DevOps\forks\pssg-cscp-cpu\Database\Model --settingsTemplateFile C:\git\DevOps\forks\pssg-cscp-cpu\Database\Model\builderSettings.json
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Database.Model
{
	...
	public partial class DatabaseContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="Database.Model.Organization"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Database.Model.Organization> OrganizationSet
		{
			get
			{
				return this.CreateQuery<Database.Model.Organization>();
			}
		}
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="Database.Model.Vsd_PortalRole"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Database.Model.Vsd_PortalRole> Vsd_PortalRoleSet
		{
			get
			{
				return this.CreateQuery<Database.Model.Vsd_PortalRole>();
			}
		}
