...
export function convertContactInformationToDynamics(
  ...
  return {
    ...
    organization: {
      ...
      address1_postalcode:
        trans.contactInformation.mainAddress.postalCode || null,
      address1_stateorprovince:
        trans.contactInformation.mainAddress.province || null,
      ...
      address2_postalcode:
        trans.contactInformation.mailingAddress.postalCode || null,
      address2_stateorprovince:
        trans.contactInformation.mailingAddress.province || null,
